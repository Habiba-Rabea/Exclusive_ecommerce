        ...
        <div className='product-card'>
            <div className='product-img'>
                ...
                <div className='product-icons'>
                    ...
                    <Link to={`/product/${productData.id}`} className="iconn-btn" aria-label="View Details" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none', color: 'inherit' }}>
                        <Eye size={20} />
                    </Link>
                </div>
